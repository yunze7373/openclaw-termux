...
This is a **Termux-optimized fork** of OpenClaw, designed to run natively on Android devices.

Key adaptations:
- ✅ **Full Android/Termux compatibility** - no root required
- ✅ **Termux-specific path handling** - adapted for Android filesystem
- ✅ **Multi-node distributed architecture** - connect multiple compute nodes
- ✅ **Custom mobile skills** - voice, notifications, hardware integration
- ✅ **Enhanced memory system** - local embeddings with Supabase
