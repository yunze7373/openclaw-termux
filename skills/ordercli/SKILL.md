...
metadata: {"moltbot":{"emoji":"📦","requires":{"bins":["ordercli"]},"install":[{"id":"brew","kind":"brew","formula":"steipete/tap/ordercli","bins":["ordercli"],"label":"Install ordercli (brew)"},{"id":"go","kind":"go","module":"github.com/steipete/ordercli@latest","bins":["ordercli"],"label":"Install ordercli (go)"}]}}
---
